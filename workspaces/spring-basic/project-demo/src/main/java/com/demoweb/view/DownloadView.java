...
public class DownloadView extends AbstractView {
	...
	protected void renderMergedOutputModel(Map<String, Object> model, // 컨트롤러에서 전달한 데이터 수신 
		...
		BoardAttachDto attachment = (BoardAttachDto)model.get("attach"); // Controller에서 전달한 데이터 읽기
		...
		String path = application.getRealPath("/resources/upload/" + attachment.getSavedFileName());
